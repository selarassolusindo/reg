...
*/
$config['tables']['users']           = 't90_users';
$config['tables']['groups']          = 't91_groups';
$config['tables']['users_groups']    = 't92_users_groups';
$config['tables']['login_attempts']  = 't93_login_attempts';
